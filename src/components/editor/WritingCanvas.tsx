  ...
  return (
    <div className="w-full relative flex flex-col items-center">
      ...
      <div className="max-w-[800px] xl:max-w-[1200px] w-full mx-auto px-8 py-16 relative flex gap-8 transition-all">
        ...
        {/* Right Sidebar */}
        {activeSidebar && (
          <div className="hidden lg:flex flex-col w-80 flex-shrink-0 border-l border-border/50 pl-6 h-[calc(100vh-60px)] sticky top-[60px]">
          ...
          <div className="flex items-center gap-4 border-b border-border mb-4 pb-2">
            <button
              ...
              className={`flex items-center gap-1.5 text-sm font-medium pb-2 border-b-2 transition-colors -mb-[9px] ${
                activeSidebar === 'outline' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 text-sm font-medium pb-2 border-b-2 transition-colors -mb-[9px] ${
                activeSidebar === 'comments' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 text-sm font-medium pb-2 border-b-2 transition-colors -mb-[9px] ${
                activeSidebar === 'revisions' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'
              }`}
            >
          ...
          <div className="flex-1 overflow-hidden relative border-t border-border mt-[1px]">
