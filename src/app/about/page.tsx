      ...
      <div className="min-h-screen bg-[#050505] text-white selection:bg-white/20 selection:text-white font-sans overflow-x-hidden relative">
        ...
        <main className="relative z-10 w-full max-w-4xl mx-auto px-6 md:px-12 pt-48 pb-32">
          ...
          <div className="mb-24 animate-fade-in-up">
            <h1 className="text-[4rem] md:text-[6rem] font-sans font-bold tracking-tighter leading-[0.95] text-white mb-8">
          ...
          <article className="prose prose-stone prose-lg md:prose-xl max-w-none prose-headings:font-sans prose-headings:tracking-tighter prose-headings:text-white prose-p:font-sans prose-p:leading-relaxed prose-p:tracking-tight prose-p:text-white/80 prose-a:text-white prose-strong:text-white animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <p className="text-2xl md:text-3xl font-medium leading-snug mb-16 text-white/90">
            ...
            <div className="my-20 py-12 border-y border-white/[0.08]">
              <p className="text-3xl md:text-5xl font-serif italic text-white leading-tight text-center">
            ...
            <ul className="space-y-6 list-none pl-0 my-12">
              <li className="flex gap-6 items-start">
                <span className="font-serif italic text-3xl text-white/30">01.</span>
              ...
              <li className="flex gap-6 items-start">
                <span className="font-serif italic text-3xl text-white/30">02.</span>
              ...
              <li className="flex gap-6 items-start">
                <span className="font-serif italic text-3xl text-white/30">03.</span>
              ...
              <li className="flex gap-6 items-start">
                <span className="font-serif italic text-3xl text-white/30">04.</span>
